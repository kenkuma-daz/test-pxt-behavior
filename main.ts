function 敵生成 (sprite: Sprite) {
    ...
    behavior.setPattern(mySprite2, behavior.MovePattern.TurnIfOnWall, 50, 150)
...
function 敵生成2 (sprite: Sprite) {
    mySprite2 = sprite
    behavior.setPattern(mySprite2, behavior.MovePattern.FlyAndTurnOnSideWall, 50, 150)
    behavior.setAttacker(mySprite2, mySprite, sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . b . . . . . . . 
...
console.log(game.currentScene().tileMap.scale)
mySprite2 = sprites.create(img`
    ...
    . f f . . f f . . f f . . . 
    `, SpriteKind.Enemy)
behavior.setPattern(mySprite2, behavior.MovePattern.WalkOnFloor, 50, 150)
behavior.setAttacker(mySprite2, mySprite, sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
